    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="homest.jsp">INTRANET MOOCs</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-fw"></i> <%=userMooc.getLogin()%> <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-user">
                        <li class="divider"></li>
                        <li><a href="quitter.jsp"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="homest.jsp"><i class="fa fa-dashboard fa-fw"></i>Acceuil</a>
                        </li>
                         <li>
                            <a href="mycourse.jsp"><i class="fa fa-bar-chart-o fa-fw"></i> <b> Mes Cours</b> </a>

                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                                    <a href="toutcours.jsp"><span class="glyphicon glyphicon-book"></span>Tout les cours </a>
                                </li>
                        </ul>
                </div>
                <!-- /.sidebar-collapse -->
