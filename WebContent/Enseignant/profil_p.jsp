            		...
            		<div class="box-body box-profile">
						...
						<ul class="list-group list-group-unbordered">
			                <li class="list-group-item">
			                  <b>Matricule</b> <a class="pull-right"><%=etudiant.getMatriculeId(id_etudiant) %></a>
			                </li>
			                <li class="list-group-item">
			                  <b>Email</b> <a class="pull-right"><%=etudiant.getEmailId(id_etudiant) %></a>
			                </li>
			                <li class="list-group-item">
			                  <b>Cours</b> <a class="pull-right"><%=etudiant.getMesCours().size()%></a>
			                </li>
			            </ul>
					<a href="#" class="btn btn-primary btn-block"  id="imprime"><b>Imprimer R&eacute;capitulatif <i class="fa fa-print"> </i></b></a>
            		</div>
            	</div>
     		</div>
     		...
     		<div class="col-md-9">
     			<div class="nav-tabs-custom">
		            <ul class="nav nav-tabs">
		              <li class="active"><a href="#courses" data-toggle="tab">Ses cours</a></li>
		              <li><a href="#bord" data-toggle="tab">Tableau de bord</a></li>
		              <li><a href="#perso" data-toggle="tab">Personnel</a></li>
		            </ul>
				...
				<thead>
					...
					<tr>
							...
							<th> <center>#</center> </th>
							<th> <center>Nom du Cours</center> </th>
							<th> <center>Nom du Prof</center> </th>
							<th> <center>Categorie du Cours</center> </th>
				...
				<tbody>
					...
					<%ArrayList<String> listeCours= etudiant.getMesCours();%>
						<%Cours c = new Cours();  %>
						<% for(int i = 0; i<listeCours.size(); i++){ %>
						<tr class="<%=i%2==0?"success":"info"%>">
							<td><center><%=i+1%></center></td>
							<td><center><%=listeCours.get(i).toUpperCase()%> </center></td> 
							
						<%c.setTitreCours(listeCours.get(i)) ;%>
							<td><center><%=c.getNomEnseignant() %><span class="glyphicon glyphicon-user"> </span></a></center></td>
							<td><center><%=c.getCategorieBD() %></center>
		            	...
		            	<div class="tab-pane" id="bord">
		            		...
		            		<table class="table table-bordered table-hover table-striped display" id="table3">
				...
				<thead>
					...
					<tr>
							...
							<th> # </th>
							<th> HEURE CONNEXION <span class="glyphicon glyphicon-time"></span> </th>
							<th> HEURE FIN <span class="glyphicon glyphicon-time"></span></th>
				...
				<tbody>
					...
					%>
						...
						<tr class="<%=i%2==0?"success":"info"%>">
							<td><center><%=i+1%></center></td>
							<td><center><%=rs.getString("dateDebut")%> </center></td> 
							<td><center><%=rs.getString("dateFin")%> <span class="glyphicon glyphicon-user"> </span></a></center></td>
							<%i++;%>
        				...
        				<tbody>
        					...
        					<tr>
        						<td><%=NomEtudiant.toUpperCase()%></td>
        						<td><%=etudiant.getMatriculeId(id_etudiant) %></td>
        						<td><%=etudiant.getEmailId(id_etudiant) %></td>
        						<td><%=etudiant.getTempsMoyen()%></td>
        					</tr>
...
<script src="../js/ace.js"></script>
   ...
   $('#table3x').DataTable({
    ...
    $('#imprime').click(function(e){
        ...
        doc.addImage(headerImgData, 'JPEG', 40, 40, 25, 25);
        doc.text('PROFIL DE <%=etudiant.getNom()%>', 65, 60);

        doc.text('Informations Personnelles',40,95);
        ...
        doc.text('Liste de ses cours',40,doc.autoTableEndPosY() + 30);
        var val = doc.autoTableEndPosY()+30;
        ...
        doc.text('Tableau de Bord de Connexion',40,doc.autoTableEndPosY()+30);
        val = doc.autoTableEndPosY()+30;
