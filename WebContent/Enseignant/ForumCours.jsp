		...
		<div class="row">
			<div class="col-xs-12">
				<div class="alert alert-info alert-dismissible">
	                ...
	                <span class="label label-warning pull-right" id="compte"><%=conversation.size() %></span></h4>
	         	</div>
			</div>
		</div>
		<div class="row">
		<div class="col-md-3">
				<a class="pull-left btn btn-danger btn-blog" href="ForumMenu.jsp?title=<%= request.getParameter("title")%>">Retour</a>
			</div>			
			<div class="col-md-9">
...
$(".envoi").click(function(){
	forumenvoi('*',unescape(nomCours),unescape(theme));
});
