...
<body class="hold-transition skin-blue sidebar-mini">	
   ...
   <%
               	String code = "[\"Tableau de Bord\",\"Cours\"]";
                ArrayList<String> list = connecteurForum.getListeCours(); Cours s = new Cours();
                for(String nom: list)
                {                    
                	s.setTitreCours(nom);
                	nom=nom.replace("\"","'");
		...
		<div class="row">
			...
			<div class="box box-info">
				<div class="box-header">
					<h3 class="box-title"><i class="fa fa-bar-chart"></i> STATISTIQUES SUR LES COURS</h3>
				</div>
				<div class="box-body">
				...
				<div class="box box-info">
					...
					<thead>
						<tr>
							 ...
							 <th><center> NOM ENSEIGNANT  </center></th>
			...
			$('#imprime').click(function(e){
				 ...
				 var headerImgData = 'data:image/png;base64,';
				    var header = function (data) {
				        ...
				        doc.text("Statistiques sur les cours", data.settings.margin.left + 35, 60);
				    };
