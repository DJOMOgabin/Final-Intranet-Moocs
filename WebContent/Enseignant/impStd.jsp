...
<%@ page import = "java.util.ArrayList, Modele.Cours, Modele.constante, Modele.User" %>
...
<body class="hold-transition skin-blue sidebar-mini">
	<%@ include file="entete2.jsp" %>
     <section class="content">
			...
			<div class="col-xs-12">
				...
				<div class="box box-info">
					...
					<div class="box-header with-border">
						<h3 class="box-title"> <i class="fa fa-users"></i><b> LISTE  DES ETUDIANTS INCRITS AU COURS <%=title.toUpperCase() %></b> </h3>
					</div>
					<div class="box-body">
            			...
            			<tbody>
            					...
            					<%ArrayList<Integer> listInscrit = teacher.getListeInscrit(new String(request.getParameter("title").getBytes("ISO-8859-1"),"UTF-8")); int compteur = 0; %>
            					<%User s =  new User();  %>
            					<%for(Integer id: listInscrit){ %>
            					
            							<tr>
            								<td> <center><%=++compteur %></center></td>
            								<td> <center><%=s.getNomId(id+"").toUpperCase()%></center></td>
            								<td><center><%=s.getMatriculeId(id+"") %></center></td>
            								<td><center><%=s.getEmailId(id+"") %></center></td>
            							</tr>
            					<%} %>
		...
		<%if(listInscrit.size()>0){ %>
		<div class="row">
			<div class="col-xs-12">
				<a href="#" id="imprimer" class="pull-right btn btn-flat btn-success" type="button"> IMPRIMER  <i class="fa fa-print"></i></a>
			</div>
		</div>
			<%} %>
	...
	$('#imprimer').click(function(e){
		 ...
		 var headerImgData = 'data:image/png;base64,';
		    var header = function (data) {
		        ...
		        doc.text("LISTE DES ETUDIANTS INSCRIT A <%=new String(request.getParameter("title").getBytes("ISO-8859-1"),"UTF-8").toUpperCase()%>", data.settings.margin.left + 35, 60);
		    };
		    ...
		    var elem = document.getElementById("etudiant");
