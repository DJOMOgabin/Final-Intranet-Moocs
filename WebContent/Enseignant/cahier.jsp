...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-info-circle"></i> Cahier de Pr&eacute;sence  <i class="fa fa-clock-o fa-spin"></i> </h4>
                Veuillez selectionner la date ou bien choisissez l'option <b>par intervalle</b> pour choisir un intervalle de date. 
         </div>
		</div>
		</div>
        ...
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-tag"></i> Selectionnez la date </h3>
        </div>
        ...
        <div class="box-body">
         ...
         <div  id="da">
          	...
          	<center>
					...
					<input class="datepicker"   type="text" required size="35" name="dateConnexion" id="dateConnexion">
					<button   onclick = "remplirtableauconnexion();" class="btn btn-flat btn-success" > Generer <span class="glyphicon glyphicon-play-circle"></span></button>
			...
			<center><p><label> Ou par intervalle <input id="check" type="checkbox"></label></p></center>
				<div  id="range">
				
					<center>
						<label> Date Debut </label>
						<input class="datepicker"  type="text" required size="35" name="dateConnexion1" id="dateConnexion1">
						<label> Date Fin </label>
						<input class="datepicker"  type="text" required size="35" name="dateConnexion2" id="dateConnexion2">
						<button onclick="remplirtableauconnexion2()" class="btn btn-flat btn-success"> Generer <span class="glyphicon glyphicon-play-circle"></span></button>
					</center>
		...
		<div  id="graphwait">
			...
			<a href="#" id="imprime"  type="button" class="btn  btn-flat btn-success "> Imprimer <i class="fa fa-print"></i></a>
...
<script src="../js/ace.js"></script>
    ...
    $(document).ready(function(){
    	 ...
    	 var picker = new Pikaday({
    	        field: document.getElementById('#dateConnexion'),
    	        format: 'YYYY/MMM/DD',
    	        onSelect: function() {
    	            console.log(this.getMoment().format('YYYY/MMM/DD'));
    	        }
    	    });
    	 var picker = new Pikaday({
 	        field: document.getElementById('#dateConnexion1'),
 	        format: 'YYYY/MMM/DD',
 	        onSelect: function() {
 	            console.log(this.getMoment().format('YYYY/MMM/DD'));
 	        }
    	 ...
    	 var picker = new Pikaday({
 	        field: document.getElementById('#dateConnexion2'),
 	        format: 'YYYY/MMM/DD',
 	        onSelect: function() {
 	            console.log(this.getMoment().format('YYYY/MMM/DD'));
 	        }
		...
		$('#imprime').click(function(e){
			 ...
			 var headerImgData = 'data:image/png;base64,';
			    var header = function (data) {
			        ...
			        if($('#dateConnexion1').val()!="")
			        {
			        	doc.text("Cahier de Presence du "+$('#dateConnexion1').val()+'-'+$('#dateConnexion2').val(), data.settings.margin.left + 35, 60);
			        }
			        else
			        {
				        doc.text("Cahier de Presence - "+$('#dateConnexion').val(),data.settings.margin.left + 35 , 60);
			        }

			        $('#dateConnexion').val("");$('#dateConnexion1').val("");$('#dateConnexion2').val("");
			    };
		...
		function remplirtableauconnexion2()
		{
			...
			xml.onreadystatechange=function()
			{
					...
					{
						document.getElementById("graphwait").innerHTML = xml.responseText;
						$('#wait').fadeIn();
					}
			}

			xml.open("GET","tablepresence.jsp?date1="+document.getElementById("dateConnexion1").value+"&&date2="+document.getElementById("dateConnexion2").value,false);
		 	xml.send();
		}
		function remplirtableauconnexion()
		{
			if(window.XMLHttpRequest)
				{
					xml = new XMLHttpRequest();
			...
			xml.onreadystatechange= function()
		 	...
		 	xml.open("GET","tablepresence.jsp?date="+document.getElementById("dateConnexion").value,false);
		 	xml.send();
		}
