      ...
      <ul class="sidebar-menu" onclick="active()">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="Enseignant/ajoutCours.jsp"><i class="fa fa-circle-o"></i> </i> Ajouter un cours</a></li>
            
          </ul>
        </li>
        
         <li>
          <a href="Enseignant/listeDevoir.jsp?title=<%= request.getParameter("title")%>&del=false">
            <i class="fa fa-book"></i>
        ...
        <li>
          <a href="Enseignant/listeEtd.jsp">
        ...
        <li>
          <a href="Enseignant/ForumMenu.jsp?title=<%= request.getParameter("title")%>">
