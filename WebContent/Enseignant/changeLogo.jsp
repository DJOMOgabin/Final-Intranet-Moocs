...
>>>>>>> 647841db7d091c842900a7c18b2079aeb8d6ee5b
    ...
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <h4><i class="icon fa fa-info-circle"></i> Changez le logo de <b><%=c.getTitreCours() %></b>   </h4>
              	 S&eacute;lectionnez le nouveau logo et cliquez sur <b>Changer</b>. L'ancien logo est le suivant : 
         </div>
		</div>
		</div>
		<div class="row">
			...
			<div class="col-xs-6">
				...
				<div class="embed-responsive embed-responsive-16by9">
     					<iframe class="embed-responsive-item" src="../cours/img/<%=c.getLogoCoursBD()%>" controls autoplay="false" frameborder="0" allowfullscreen></iframe>
     			</div>
			</div>
			...
			<div class="col-xs-6">
				<div class="box box-info">
					<div class="box-body">
						<form  class="form-horizontal" method="post" id="newlogo" action="upLogo.jsp?id=<%=c.getId()%>" enctype="multipart/form-data" >
		    					<div class="form-group">
		    						<label class="col-sm-2 control-label"> Nouveau logo : </label>
		    						<div class="col-sm-4"> 
		    							<input type="file" accept="image/*" value="newlogo" name="newlogo"/>
		    						</div>
		    					</div>
		    					<div class="form-group">
		    						<div class="col-xs-6">
											<button id="soumettre"  class="btn btn-flat btn-block btn-success"> Changer  <i class="fa fa-upload" id="go"></i><i class="fa fa-spinner fa-spin" id="none"></i></button>				
		 							</div>
		    					</div>
		               	</form>
	               	</div>
