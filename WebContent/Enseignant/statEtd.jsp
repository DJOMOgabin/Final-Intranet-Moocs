...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<%
               	String code = "[\"Tableau de Bord\",\"Etudiant\"]";
                ArrayList<String> list = connecteurForum.getListeNom(); User s = new User();
                for(String nom: list)
                {
                	s.setNom(nom);
                	code = code + ",[\""+nom+"\","+s.getNombreCours()+"]";
                }               
                code = code + "])";
               %>
		...
		<div class="row">
			...
			<div class="box box-info">
				<div class="box-header">
					<h3 class="box-title"><i class="fa fa-bar-chart"></i> STATISTIQUES SUR LES ETUDIANTS</h3>
				</div>
				<div class="box-body">
		...
		<div class="col-md-6">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title"><i class="fa fa-table"></i> TABLEAU RECAPITULATIF</h3>
					</div>
					<div class=box-body>
					...
					<thead>
						<tr>
							 ...
							 <th><center> NOMBRE DE COURS  </center></th>
					...
					<tbody>
								...
								<%list = connecteurForum.getListeNom(); s = new User(); %>
								<%for(int i=0; i<list.size();i++){ %>
							
						<tr class="<%=i%2==0?"success":"info"%>">
									<td><center><%=i+1 %></center></td>
												<%s.setNom(list.get(i));%>	
									<td><center><a href="profil_p.jsp?id_Etudiant=<%=s.getId()%>"><%=list.get(i).toUpperCase() %></a></center></td>
									<td><center><%=s.getMatriculeId(s.getId()+"").toUpperCase() %></center></td>
		...
		$('#imprime').click(function(e){
			 ...
			 var headerImgData = 'data:image/png;base64,';
			    var header = function (data) {
			        ...
			        doc.text("STATISTIQUES SUR LES ETUDIANTS", data.settings.margin.left + 35, 60);
			    };
