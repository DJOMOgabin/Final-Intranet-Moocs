...
<%@page import="Controleur.EpreuveFinal"%>
...
<%@ page contentType="text/html; charset=UTF-8" %>
	...
	<section class="content-header">
		...
		CopieEtudiant copie = (CopieEtudiant)request.getAttribute("copie");
		...
		%>
			...
			<input type="hidden" name="juste" value="${juste }"/>
				...
				<div class="row">
					<div class="col-md-4"><a href="liste_e.jsp?title=${title }" 
...
<script>
<%if(EpreuveFinal.isValeur()){%>
	$().toastmessage('showSuccessToast','Vos reponses ont été soumisse avec succes!');
<%}%>
$('#none').hide(); 
